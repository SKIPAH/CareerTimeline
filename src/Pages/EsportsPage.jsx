      ...
      <section className="esports-section">
        <div className="container">
          ...
          <p className="esports-text">
            ...
            been the one doing the hard parts of levels if my brothers couldn't.
            My friend groups in elementary school basically formed around other
            kids that liked games like Runescape and all the DragonBall Z games.
            Once I moved to another city for 7th grade, I ended up finding group
            of friends that played Call Of Duty 4 on pc, where I got my first
          ...
          <p className="esports-text">
            ...
            team environment competitively meant. After high school I was doing
            the mandatory finnish military service and while I had few months
            left, I found out about Overwatch videogame that going to be
            released just after my service ends. I said to my military friends
            that I'm going to become a professional Overwatch player and started
            instantly grinding hard.
          </p>
          ...
          <p className="esports-text">
            ...
            ended up gaining different opportunities in the scene but it is what
            it is. Once I quit my security guard job and started studying in
            Oulu University of Applied Sciences, I could put more time into
            Overwatch.
          </p>
          <p className="esports-text">
