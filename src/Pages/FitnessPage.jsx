    ...
    <>
      <section className="fitness-section">
        ...
        <p className="fitness-text">
          I have been quite active my whole life in different sports. Currently
          though I'm not competing in any sport, but active in gym and
          interested in all kinds of strength related activities and being
          athletic in general.
        </p>
        <p className="fitness-text">
          ...
          great joy from it. I haven't tried wrestling or track and field again
          though, but I'm very interested in strength related sports like
          powerlifting, bodybuilding, strongman and calisthenics. My goal
          currently is to just be overall athletic and not just focusing on for
          example doing only powerlifting.
        </p>
      </section>
