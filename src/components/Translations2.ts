...
const Translations: TranslationsType = {
  en: {
    ...
    "dev-thesis": "Thesis",
    "dev-itch": "Dynamic 3D simulator and product configurator with Unity game engine",
    ...
    "homepage-introduction-text-short": "Hei! Minun nimeni on Jussi Mehtälä, myös tunnettu lempinimellä SKIPAH kilpapelaamisen puolella. Etsin tällä hetkellä töitä IT-alalta ohjelmistosuunnittelijan rooliin!",
