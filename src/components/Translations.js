...
const Translations = {
  en: {
    ...
    "dev-cv": "My",
    "dev-cv-2": "and",
    "dev-webgl": "My WebGL 3D Product configurator project below, which I made for my thesis. Replaced assets with placeholders.",
    "dev-webgl-note": "NOTE!! Project disabled on mobile, because Unity WebGL projects are not fully supported on mobile devices. Enable hardware acceleration, if you are using Google Chrome",
    "fitness-title": "Sports and Fitness",
    "dev-thesis": "Link to whole thesis",
    "dev-itch": "Itch IO project of my thesis with proper assets",
    "aboutMe": "About me",
   ...
   "esports-title-text": "My journey as a esports athlete!",
    ...
    "dev-cv": "Minun",
    "dev-cv-2": "ja",
    "dev-webgl": "Minun WebGL 3D tuotekonfiguraattori alla, jonka tein opinnäytetyönä. Nucun tiedostot korvattu placeholdereilla.",
    "dev-webgl-note": "HUOM!! Ohjelma poissa käytöstä mobiililaitteilla, koska Unity WebGL projekteja ei tueta täysin mobiiliversiossa. Aktivoi laitteistokiihdytys, jos käytät Google Chromea.",
    "fitness-title": "Urheilu ja fitness",
    "dev-thesis": "Linkki opinnäytetyöhön",
    "dev-itch": "Itch IO linkki projektiini, jossa on oikeat assetit",
    "aboutMe": "Tietoa minusta",
    "aboutMe-text": "Olen Jussi Mehtälä ja tämä on verkkosivuni, josta voit löytää tietoa minusta ja harrastuksistani.",
    ...
    "esports-text-6": "Pelasin muutamassa eri suomalaisessa joukkueessa ja turnauksessa, ennen kuin törmäsin julkaisuun jossa Nyyrikki esports niminen joukkue etsii suomalaisia pelaajia edustamaan Overwatch joukkuetta. Kiinnostuin välittömästi, koska tämä voisi olla se mahdollisuus, jolloin ura ammattilaiseksi alkaisi. JATKAN TEKSTEJÄ MYÖHEMMIN...",
