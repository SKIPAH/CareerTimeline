...
const Translations = {
  en: {
    ...
    "fitness-text":
      "I have been quite active my whole life in different sports. Currently I'm not competing in any, but active in gym and interested in all kinds of strength related activities like powerlifting, calisthenics and being athletic in general.",
    "fitness-text-2":
