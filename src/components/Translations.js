...
const Translations = {
  en: {
    ...
    "homepage-introduction-text-short": "Hei! Mun nimi on Jussi Mehtälä, olen 28-vuotias suomalainen mies ja olen valmistunut tieto ja viestintätekniikan insinööriksi suuntautumisena ohjelmistokehitys. Etsin tällä hetkellä töitä IT-alalta ohjelmistosuunnittelijan rooliin!",
