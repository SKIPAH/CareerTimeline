...
const Translations = {
  en: {
    ...
    "esports-text": "Vuosina 2019-2022 edustin esports kilpapelaajana useita Suomalaisia ja Eurooppalaisia joukkueita ja organisaatioita Overwatch ja Valorant videopeleissä. Tässä on minun ",
    "esports-text-2": "sivu, josta näkee saavutukset ja joukkueeni.",
