...
const Translations = {
  en: {
    ...
    "dev-cv": "My",
    "dev-cv-2": "and",
    "dev-webgl": "My WebGL project, which I made for my thesis. Replaced assets with placeholders.",
    ...
    "dev-cv": "Minun",
    "dev-cv-2": "ja",
    "dev-webgl": "Minun WebGL projekti, jonka tein opinnäytetyönä. Nucun tiedostot korvattu placeholdereilla.",
