...
const Translations = {
  en: {
    ...
    "homepage-introduction-text-short-note": "NOTE!! This website is still under construction! Texts, colors, layouts etc etc are not final. I will update the website each time I add/fix/learn something new",
    "homepage-introduction-text": "I have recently graduated as a Bachelor of Engineering in information technology specialized in software development. I wanted to learn more about Web Development and decided to create my own website to showcase all kinds of stuff what I like to do and have accomplished in my life! Plan is to update this website always when I feel like adding information in it. Also idea is to have this as a cool personal project to show in CV when applying for job opportunities in the tech industry or possibly something else. I currently have most experience related to programming with the Unity game engine and C# language. I consider myself still a newbie with dev skills, so this website will definitely have lots of errors.",
    ...
    "dev-title": "Development related",
    "dev-text": "I have graduated as a Bachelor of Engineering in information technology specialized in software development. All my important work and school related files and projects can be found here",
    "dev-linkedin": "My",
    "dev-linkedin-2": "and",
    ...
    "dev-text": "Olen valmistunut tieto ja viestintätekniikan insinööri suuntautumisena ohjelmistokehitys. Kaikki tärkeimmät työhön ja koulutukseen liittyvät tiedostot ja projektit löytyvät täältä.",
    "dev-linkedin": "Minun",
    "dev-linkedin-2": "ja",
