...
let TimelineElements = {
  en: [
    ...
    {
      id: 3,
      title: "Nyyrikki Esports, E-Urheilija",
      location: "Oulu, Etätyö",
      description: "Nyyrikki Esports joukkueen edustus Overwatch videopelissä eri tapahtumissa Suomessa.",
      buttonText: "Liquidpedia profiili",
      date: "Tammikuu 2018-Huhtikuu 2019",
      icon: nyyrikki,
      buttonLink: "https://liquipedia.net/overwatch/SKIPAH",
